...
const BasketButton = ({ isWhite, style, navigation }) => (
  <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate('Pro')}>
    {/* <Icon family="NowExtra" size={16} name="pin-3" color={'red'} /> */}
    <Ionicons name="add-outline" size={32} color={nowTheme.COLORS[isWhite ? 'WHITE' : 'ICON']} />
  </TouchableOpacity>
);

const AddButton = ({ isWhite, style, navigation, navigateTo }) => (
  <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate(navigateTo)}>
    {/* <Icon family="NowExtra" size={16} name="pin-3" color={'red'} /> */}
    <Ionicons name="add-outline" size={32} color={nowTheme.COLORS[isWhite ? 'WHITE' : 'ICON']} />
  </TouchableOpacity>
);
      ...
      case 'Disaster Reports':
        return [
          ...
          <AddButton
            ...
            isWhite={white}
            navigateTo="Create Report"
          />,
        ];
      case 'Create Report':
        return [
          // <BellButton key="chat-deals" navigation={navigation} isWhite={white} />,
          <BackButton key="basket-deals" navigation={navigation} isWhite={white} />,
        ];
      ...
      case 'Damage Reports':
        return [
          ...
          <AddButton
            ...
            navigation={navigation}
            isWhite={white}
            navigateTo="Create Damage Report"
          />,
        ];
      ...
      <Block row style={styles.options}>
        ...
        >
          <Block row middle>
            ...
            />
            <Text style={{ fontFamily: 'montserrat-regular', ...styles.tabTitle }} size={16}>
              {optionLeft || 'Registeries'}
            </Text>
          </Block>
        </Button>
        <Button shadowless style={styles.tab} onPress={() => navigation.navigate('Camps')}>
          <Block row middle>
            <Icon
              size={18}
              name="bag-162x"
